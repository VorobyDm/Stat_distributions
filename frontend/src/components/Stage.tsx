...
export function Stage({ dist, numSamples, results, palette, loading }: Props) {
  ...
  const dataAvailable = variants.length > 0;
  const showPanel = showData && dataAvailable;
  ...
  return (
    <div className="v2-stage">
      <div className="v2-stage-h">
        ...
        <div className="v2-stage-meta-col">
          ...
          <button
            type="button"
            className="v2-data-btn"
            onClick={() => setShowData((s) => !s)}
            disabled={!dataAvailable}
          >
            {showPanel ? "скрыть данные" : "посмотреть данные"}
          </button>
        </div>
      </div>

      <div className="v2-stage-mid">
